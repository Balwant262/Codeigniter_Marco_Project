  ...
  <div class="content-wrapper settingPage">
    ...
    <section class="content">
      ...
      <div class="box box-success" >
        <div class="box-customerer with-border">
                ...
                <div class="tab-content col-md-9">
                  <div class="tab-pane fade in" id="templates-div"></div>
                    <div class="tab-pane fade active in" id="tab_General">
                      <div class="row">
                        <div class="box-customerer my-customerer">
                 ...
                 $leads = isset($setPermissionCheck->leads)?$setPermissionCheck->leads:'';
                        $leads_edit = isset($setPermissionCheck->leads_edit)?$setPermissionCheck->leads_edit:'';
                        $leads_view = isset($setPermissionCheck->leads_view)?$setPermissionCheck->leads_view:'';
                        $customer = isset($setPermissionCheck->customer)?$setPermissionCheck->customer:'';
                        $customer_edit = isset($setPermissionCheck->customer_edit)?$setPermissionCheck->customer_edit:'';
                        $customer_view = isset($setPermissionCheck->customer_view)?$setPermissionCheck->customer_view:'';
                       
                                              } else {
                                                $setPermissionCheck =array();$all_create = '';$all_read = '';$all_update = '';$all_delete = '';
                                                  $leads='';
                          $leads_edit='';
                          $leads_view='';
                          ...
                          $customer_view='';
                                            ...
                                            ?>
                                             <!--  <tr>
                                              ...
                                              <tr>
                                                <th scope="row" class="thfont">leads</th>
                                                <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $perkey;?>][leads]" value="1" <?php if($leads==1){echo"checked";}?>/></td>
                                                <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $perkey;?>][leads_edit]"  value="1" <?php if($leads_edit==1){echo"checked";}?>/></td>
                                                <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $perkey;?>][leads_view]"  value="1" <?php if($leads_view==1){echo"checked";}?>/></td>
                                               
                                              </tr>
                                                     <tr>
                                                <th scope="row" class="thfont">customer</th>
                                                <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $perkey;?>][customer]" value="1" <?php if($customer==1){echo"checked";}?>/></td>
                                                <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $perkey;?>][customer_edit]"  value="1" <?php if($customer_edit==1){echo"checked";}?>/></td>
                                                <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $perkey;?>][customer_view]"  value="1" <?php if($customer_view==1){echo"checked";}?>/></td>
                                      ...
                                      ?>
                                                ...
                                                <tr>
                                                  <th scope="row" class="thfont">Leads</th>
                                                  <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $key1;?>][leads]" value="1"/></td>
                                                  <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $key1;?>][leads_edit]"  value="1"/></td>
                                                  <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $key1;?>][leads_view]"  value="1"/></td>
                                                  
                                                </tr>
                                                <tr>
                                                  <th scope="row" class="thfont">Customer</th>
                                                  <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $key1;?>][customer]" value="1"/></td>
                                                  <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $key1;?>][customer_edit]"  value="1"/></td>
                                                  <td><input type="checkbox" name="data[<?php echo $user_type;?>][<?php echo $key1;?>][customer_view]"  value="1"/></td>
