...
<h4 class="box-title">View Customer</h4>
		...
		<tr>
			...
			<td width="160"><?php echo $customerData->cust_fname." ".$customerData->cust_mname." ".$customerData->cust_lname; ?></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="150"><?php echo $customerData->address1.'<br>'.$customerData->address2; ?></td>
		</tr>
		<tr>
