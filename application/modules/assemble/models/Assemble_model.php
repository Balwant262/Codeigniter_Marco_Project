<?php 
class Assemble_model extends CI_Model {       
     ...
     */
	function delete($id='') {
		$this->db->where('assemble_id', $id);  
		$this->db->delete('assemble'); 
		 $this->db->where('asemble_id', $id);  
		$this->db->delete('assemble_product');
	...
	/**
      ...
      */
  	...
  	public function get_pro2_name($id)
  	{
